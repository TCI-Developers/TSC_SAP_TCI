...
function postResultado(res, result, table) {
    ...
    (0, ajax_1.ajax)({ createXHR: utils_1.createXHR, url, method: 'POST', headers: utils_1.headers, body: argSResultCorte }).pipe((0, operators_1.timeout)(20000), (0, operators_1.retry)(1)).subscribe(resp => res.render(`${pathViews}/proveedores.hbs`, { tipo: 'Resultdo Corrida', creados_modificados: resp }), (err) => res.json(err));
