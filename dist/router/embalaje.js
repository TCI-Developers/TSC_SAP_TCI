...
embalaje.get('/embalaje/:type', (req, res) => {
    ...
    client.connect((result, err) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        client.invoke('Z_RFC_NORMA_EMBALAJE', {}, (err, result) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            (0, ajax_1.ajax)({ createXHR: utils_1.createXHR, url: 'https://api.quickbase.com/v1/records', method: 'POST', headers: utils_1.headers, body: args }).pipe((0, operators_1.timeout)(60000), (0, operators_1.retry)(5), (0, operators_1.pluck)('response', 'metadata')).subscribe(respuesta => res.json({ creados_modificados: respuesta }), err => res.json(err));
        }));
    }));
});
